...
COPY HackathonAlerts.sln ./
COPY src/HackathonAlerts.Api/HackathonAlerts.Api.csproj src/HackathonAlerts.Api/
...
# Publicar o projeto
RUN dotnet publish src/HackathonAlerts.Api/HackathonAlerts.Api.csproj -c Release -o /app/publish
...
NEW_RELIC_APP_NAME="hackathon-alerts-newrelic"
...
ENTRYPOINT ["dotnet", "HackathonAlerts.Api.dll"]
